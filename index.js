...
const displaySpecies = async () => {
	try {
		...
		Object.entries(data.species).forEach(([category, speciesList]) => {
			...
			let categoryHtml = `
                    <div class="flex justify-between items-center bg-white text-customBlue p-4 md:w-3/4 md:my-16 lg:my-12 xl:my-20">
					...
					species.description
						...
						species.taxon_id
							...
							species.taxon_id
                                ...
                                <div class="text-customBlue text-md xl:text-3xl font-semibold">Click card to read more!</div>
